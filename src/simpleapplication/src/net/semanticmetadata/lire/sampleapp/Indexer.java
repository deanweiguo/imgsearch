...
package simpleapplication.src.net.semanticmetadata.lire.sampleapp;
...
//        }
       ...
       if (f.exists() && f.isDirectory()) passed = true;
        ...
        ArrayList<String> images = FileUtils.getAllImages(new File("F:/ferrari"), true);
